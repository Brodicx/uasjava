 ...
 * @author HD
 */
public class fxmlcardController implements Initializable {
    ...
    public void setData(productdata prodData) {
        ...
        image = new Image(path, 241, 241, false, true);
    ...
    public void addBtn() throws SQLException {
        ...
        fxmlmainController mForm = new fxmlmainController();
        mForm.CustomerID();
        ...
        try {
            ...
            if (!check.equals("Available") || qty == 0) {
                ...
                if (checkStck < qty) {
                    ...
                    prepare.setString(9, data.displayusername);
